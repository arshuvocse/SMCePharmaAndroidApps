...
public class TourPlanPresenter implements ITourplan.Presenter {
    Context context;
    DBCrudHelper dbCrudHelper;
    ITourplan.View view;
    ProgressDialog progressDoalog;

    public TourPlanPresenter(ITourplan.View view, Context context) {
        this.view = view;
    ...
    @Override
    public void getTourPlanDailyByEmpId(int month, int year, int empId,String date) {
        try {
            ...
            call.enqueue(new Callback<List<TourPlanViewModel>>() {
                ...
                public void onResponse(@NonNull Call<List<TourPlanViewModel>> call, @NonNull Response<List<TourPlanViewModel>> response) {
                    ...
                    md.setaTpViewList(response.body());
    ...
    @Override
    public void getTourPlanDataByEmpId(List<MonthDate> aMondateList,boolean is_Entry, int month, int year, int empId) {
            ...
            call.enqueue(new Callback<ResultInfo>() {
                ...
                public void onResponse(@NonNull Call<ResultInfo> call, @NonNull Response<ResultInfo> response) {
                    ...
                    if (info.getSuccess() == true) {
                        view.OnSuccessTPPDay("TourPlanSave");
                    } else {
                        Toast.makeText(context, "TourPlan Not Save", Toast.LENGTH_SHORT).show();
                    }
                }
