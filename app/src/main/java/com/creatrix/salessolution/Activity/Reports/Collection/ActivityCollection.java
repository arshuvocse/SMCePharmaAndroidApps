package com.creatrix.salessolution.Activity.Reports.Collection;
...
import com.creatrix.salessolution.Activity.Reports.Adapter.AdapterCollectionReport;
...
import com.creatrix.salessolution.databinding.ActivityCollectionBinding;
...
public class ActivityCollection extends AppCompatActivity implements IMarketStracture.View{
ActivityCollectionBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mkpresenter = new MarketStructurePresenter(this, ActivityCollection.this);
        today = new SimpleDateFormat("dd-MMM-yyyy", Locale.getDefault()).format(new Date());
        pd=new ProgressDialog(ActivityCollection.this);
    ...
    public void GetReportData(HashMap<String,String> map) {
        ...
        try {
            ...
            Call<List<ResponseBonusGift>> call = service.GetCollection(map);
    ...
    private void LoadinView(ResponseBonusGift body) {
        binding.tvAmount.setText(body.getTotalAmount());
        AdapterCollectionReport mAdapter = new AdapterCollectionReport(body.getLists(), ActivityCollection.this);
    ...
    private void openFilter() {
        bsheetdlg = new BottomSheetDialog(ActivityCollection.this);
        ...
        ftm.filterMonthYearLayout.ivDatePickerFromDate.setOnClickListener(v -> UtilityHelper._datePickerDialogeForDates(ftm.filterMonthYearLayout.txtFromDate, ActivityCollection.this));
        ...
        ftm.filterMonthYearLayout.ivDatePickerToDate.setOnClickListener(v -> {
            if (ftm.filterMonthYearLayout.txtFromDate.getText().toString().isEmpty()) {
                ...
                UtilityHelper._datePickerDialogeForDates(ftm.filterMonthYearLayout.txtToDate, ActivityCollection.this);
            }
        });
    ...
    public void vGroup(List<Group> groupList) {
        try {
            if (groupList != null) {
                ...
                ArrayAdapter<Group> dataAdapter = new ArrayAdapter<>(ActivityCollection.this, android.R.layout.simple_spinner_item, groupList);
    ...
    public void vRegion(List<Region> regionList) {
        try {
            if (regionList != null) {
                ...
                ArrayAdapter<Region> dataAdapter = new ArrayAdapter<>(ActivityCollection.this, android.R.layout.simple_spinner_item, regionList);
                dataAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
    ...
    public void vArea(List<Area> areaList) {
        try {
            if (areaList != null) {
                ...
                areaList.add(0, a);
                ArrayAdapter<Area> dataAdapter = new ArrayAdapter<>(ActivityCollection.this, android.R.layout.simple_spinner_item, areaList);
                dataAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
    ...
    public void vTeritory(List<Teritorry> teritoryList) {
        try {
            if (teritoryList != null) {
                ...
                ArrayAdapter<Teritorry> dataAdapter = new ArrayAdapter<>(ActivityCollection.this, android.R.layout.simple_spinner_item, teritoryList);
                dataAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
    ...
    public void vSTeritory(List<SubTeritorry> steritoryList) {
        try {
            if (steritoryList != null) {
                ...
                ArrayAdapter<SubTeritorry> dataAdapter = new ArrayAdapter<>(ActivityCollection.this, android.R.layout.simple_spinner_item, steritoryList);
                dataAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
    ...
    public void vMarket(List<Market> marketList) {
        try {
            if (marketList != null) {
                ...
                ArrayAdapter<Market> dataAdapter = new ArrayAdapter<>(ActivityCollection.this, android.R.layout.simple_spinner_item, marketList);
                dataAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
