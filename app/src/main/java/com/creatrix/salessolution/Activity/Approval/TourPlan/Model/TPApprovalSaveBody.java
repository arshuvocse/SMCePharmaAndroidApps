...
public class TPApprovalSaveBody {
     int TourPlanApprovalId;
     String Date;
    int FromEmpId;
    int ToEmpId;
    int TableId;
    ...
    public int getTourPlanApprovalId() {
        return TourPlanApprovalId;
    }

    public void setTourPlanApprovalId(int tourPlanApprovalId) {
        TourPlanApprovalId = tourPlanApprovalId;
    }
