...
import com.creatrix.salessolution.databinding.ActivityCustomerEditListBinding;
...
public class CustomerEditListActivity  extends AppCompatActivity implements ICustomer.View, IMarketStracture.View, ICustomerAdd.View {
    ActivityCustomerEditListBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCustomerEditListBinding.inflate(getLayoutInflater());
        ...
        mkpresenter = new MarketStructurePresenter(this, CustomerEditListActivity.this);
        //session.checkLogin();
        ...
        binding.toolbarCustom.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Log.e("ToolbarNav", "finish() failed", e);
                    Toast.makeText(v.getContext(), "Couldn't close screen. Please try again.", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        try {
            if (crudHelper.CheckDataInTable("tblCustomerInfo") == true) {
                customerArrayList = crudHelper.getCustomerList_SQLiteBSP();
                OnSuccessz(customerArrayList, orderTYpe);
            } else

            {
                Toast.makeText(this, "Please Sync Customer", Toast.LENGTH_SHORT).show();
              //  getCustomerList(empId, orderTYpe);
            }
    ...
    /*    FilterMasterBinding ftm;
        ftm = FilterMasterBinding.inflate(getLayoutInflater());*/
        bsheetdlg = new BottomSheetDialog(CustomerEditListActivity.this);
...
/*        ftm.filterMonthYearLayout.txtFromDate.setText(today);
        ...
        ctypeList.add(0, r);
        ArrayAdapter<CustomerType> customerTypeAdapter = new ArrayAdapter<>(CustomerEditListActivity.this, R.layout._custom_spinner_tv, ctypeList);
        ...
        ArrayAdapter<ModelProviderType> providerAdapter = new ArrayAdapter<>(CustomerEditListActivity.this, R.layout._custom_spinner_tv, providertypeList);
        ...
        ArrayAdapter<ModelSMCType> pharmaAdapter = new ArrayAdapter<>(CustomerEditListActivity.this, R.layout._custom_spinner_tv, pharmatypeList);
    ...
    private void getCustomerList(int empId, String orderTYpe) {
        progressDoalog = new ProgressDialog(CustomerEditListActivity.this);
    ...
    public void vGroup(List<Group> groupList) {
        try {
            if (groupList != null) {
                ...
                ArrayAdapter<Group> dataAdapter = new ArrayAdapter<>(CustomerEditListActivity.this, android.R.layout.simple_spinner_item, groupList);
    ...
    public void vRegion(List<Region> regionList) {
        try {
            if (regionList != null) {
                ...
                ArrayAdapter<Region> dataAdapter = new ArrayAdapter<>(CustomerEditListActivity.this, android.R.layout.simple_spinner_item, regionList);
                dataAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
    ...
    public void vArea(List<Area> areaList) {
        try {
            if (areaList != null) {
                ...
                areaList.add(0, a);
                ArrayAdapter<Area> dataAdapter = new ArrayAdapter<>(CustomerEditListActivity.this, android.R.layout.simple_spinner_item, areaList);
                dataAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
    ...
    public void vTeritory(List<Teritorry> teritoryList) {
        try {
            if (teritoryList != null) {
                ...
                ArrayAdapter<Teritorry> dataAdapter = new ArrayAdapter<>(CustomerEditListActivity.this, android.R.layout.simple_spinner_item, teritoryList);
                dataAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
    ...
    public void vSTeritory(List<SubTeritorry> steritoryList) {
        try {
            if (steritoryList != null) {
                ...
                ArrayAdapter<SubTeritorry> dataAdapter = new ArrayAdapter<>(CustomerEditListActivity.this, android.R.layout.simple_spinner_item, steritoryList);
                dataAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
    ...
    public void vMarket(List<Market> marketList) {
        try {
            if (marketList != null) {
                ...
                ArrayAdapter<Market> dataAdapter = new ArrayAdapter<>(CustomerEditListActivity.this, android.R.layout.simple_spinner_item, marketList);
                dataAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
