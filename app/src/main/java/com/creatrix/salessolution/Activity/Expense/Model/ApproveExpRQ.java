...
public class ApproveExpRQ {
    int ExpanseApprovalId;
    String Date;
    int FromEmpId;
    int ToEmpId;
    int TableId;
    ...
    public int getExpanseApprovalId() {
        return ExpanseApprovalId;
    }

    public void setExpanseApprovalId(int expanseApprovalId) {
        ExpanseApprovalId = expanseApprovalId;
    }
