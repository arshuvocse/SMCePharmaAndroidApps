...
import com.creatrix.salessolution.databinding.ActivityDwsptargetBinding;
import java.util.HashMap;
import java.util.Objects;

public class DWSPTargetActivity extends AppCompatActivity{
    ActivityDwsptargetBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityDwsptargetBinding.inflate(getLayoutInflater());
        ...
        pd=new ProgressDialog(DWSPTargetActivity.this);
        pd.setTitle("Loading");
        pd.setMessage("Please wait...");

        if (NetworkInformation.isConnected(DWSPTargetActivity.this)) {
           viewLoad(empId);
        } else {
