...
@Keep public class PrescApprovalRQ {
    int PrescriptionApprovalId;
    String Date;
    int FromEmpId;
    int ToEmpId;
    int TableId;
    ...
    public int getPrescriptionApprovalId() {
        return PrescriptionApprovalId;
    }

    public void setPrescriptionApprovalId(int prescriptionApprovalId) {
        PrescriptionApprovalId = prescriptionApprovalId;
    }
    ...
    public int getEntryByS() {
        return EntryByS;
    }

    public void setEntryByS(int entryByS) {
        EntryByS = entryByS;
    }
    ...
    public int getApproveByS() {
        return ApproveByS;
    }

    public void setApproveByS(int approveByS) {
        ApproveByS = approveByS;
    }

    public int getApproveDateS() {
        return ApproveDateS;
    }

    public void setApproveDateS(int approveDateS) {
    ...
    public int getEntryByApp() {
        return EntryByApp;
    }

    public void setEntryByApp(int entryByApp) {
    ...
    public int getApproveByApp() {
        return ApproveByApp;
    }

    public void setApproveByApp(int approveByApp) {
