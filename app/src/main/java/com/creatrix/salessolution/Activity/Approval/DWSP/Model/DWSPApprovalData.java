...
public class DWSPApprovalData {
    ...
    @SerializedName("DWSPApprovalId")
    @Expose
    private Integer dWSPApprovalId;
    ...
    @SerializedName("aDWSPMasterDAO")
    @Expose
    private ADWSPMasterDAO aDWSPMasterDAO;
    ...
    public Integer getdWSPApprovalId() {
        return dWSPApprovalId;
    }

    public void setdWSPApprovalId(Integer dWSPApprovalId) {
        this.dWSPApprovalId = dWSPApprovalId;
    }
    ...
    public ADWSPMasterDAO getaDWSPMasterDAO() {
        return aDWSPMasterDAO;
    }

    public void setaDWSPMasterDAO(ADWSPMasterDAO aDWSPMasterDAO) {
        this.aDWSPMasterDAO = aDWSPMasterDAO;
    }
}
