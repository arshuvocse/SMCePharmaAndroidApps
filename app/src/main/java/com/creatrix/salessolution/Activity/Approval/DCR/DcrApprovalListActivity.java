...
public class DcrApprovalListActivity extends AppCompatActivity implements IDcrApproval.View, IDoctor.View , IMarketStracture.View ,DcrApprovalAdapter.approveTDCR{
    ActivityDcrApprovalBinding binding;
    DcrApprovalPresenter presenter;
    BottomSheetDialog bsheetdlg;
    DBCrudHelper dbCrudHelper;
    DcrApprovalAdapter dcrAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setContentView(R.layout.activity_dcr_approval);
        binding = ActivityDcrApprovalBinding.inflate(getLayoutInflater());
        presenter = new DcrApprovalPresenter(this, DcrApprovalListActivity.this);
        setContentView(binding.getRoot());
        pd = new ProgressDialog(DcrApprovalListActivity.this);

        session = new SessionManagement(DcrApprovalListActivity.this);
        ftm = FilterMasterBinding.inflate(getLayoutInflater());
        crudHelper = new DBCrudHelper(this);
        mkpresenter = new MarketStructurePresenter(this, DcrApprovalListActivity.this);
        //session.checkLogin();
      ...
      HashMap<String ,String >  filtera = new HashMap<>();
        ...
        binding.swip.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                filtera.put("doctortype","0");
                hitApi(params, filtera);
               // presenter.getDcrApprovalList(params, filter);
    ...
    private void openFilter() {
        bsheetdlg = new BottomSheetDialog(DcrApprovalListActivity.this);
        ...
        ftm.filterTypeLayout.tilDoctype.setVisibility(View.VISIBLE);
...
/*       ftm.filterMonthYearLayout.txtFromDate.setText(today);
        ...
        ftm.filterMonthYearLayout.ivDatePickerFromDate.setOnClickListener(v -> {
            UtilityHelper._datePickerDialogeForDates(ftm.filterMonthYearLayout.txtFromDate, DcrApprovalListActivity.this);
        });
        ftm.filterMonthYearLayout.ivDatePickerToDate.setOnClickListener(v -> {
            UtilityHelper._datePickerDialogeForDates(ftm.filterMonthYearLayout.txtToDate, DcrApprovalListActivity.this);
        });

        DoctorTypeVM r = new DoctorTypeVM();
        r.setDoctorTypeName("Select");
        dtypeList.add(0, r);
        ArrayAdapter<DoctorTypeVM> doctorTypeAdapter = new ArrayAdapter<>(DcrApprovalListActivity.this, R.layout._custom_spinner_tv, dtypeList);
        ...
        ArrayAdapter<ModelProviderType> providerAdapter = new ArrayAdapter<>(DcrApprovalListActivity.this, R.layout._custom_spinner_tv, providertypeList);
        ...
        ArrayAdapter<ModelSMCType> pharmaAdapter = new ArrayAdapter<>(DcrApprovalListActivity.this, R.layout._custom_spinner_tv, pharmatypeList);
    ...
    public void onGetDcrApprovalList(List<DcrApprovalData> aList) {
        ...
        if (aList != null) {
            ...
            dcrAdapter = new DcrApprovalAdapter(DcrApprovalListActivity.this, aList,this);
            LinearLayoutManager mLayoutManager = new LinearLayoutManager(getApplicationContext());
            binding.rvDcrlist.setLayoutManager(mLayoutManager);
            binding.rvDcrlist.setItemAnimator(new DefaultItemAnimator());
            binding.rvDcrlist.setAdapter(dcrAdapter);
            binding.rvDcrlist.setItemAnimator(null);
            binding.rvDcrlist.scrollToPosition(0);
    ...
    public void vGroup(List<Group> groupList) {
        try {
            if (groupList != null) {
                ...
                ArrayAdapter<Group> dataAdapter = new ArrayAdapter<>(DcrApprovalListActivity.this, android.R.layout.simple_spinner_item, groupList);
    ...
    public void vRegion(List<Region> regionList) {
        try {
            if (regionList != null) {
                ...
                ArrayAdapter<Region> dataAdapter = new ArrayAdapter<>(DcrApprovalListActivity.this, android.R.layout.simple_spinner_item, regionList);
                dataAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
    ...
    public void vArea(List<Area> areaList) {
        try {
            if (areaList != null) {
                ...
                areaList.add(0, a);
                ArrayAdapter<Area> dataAdapter = new ArrayAdapter<>(DcrApprovalListActivity.this, android.R.layout.simple_spinner_item, areaList);
                dataAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
    ...
    public void vTeritory(List<Teritorry> teritoryList) {
        try {
            if (teritoryList != null) {
                ...
                ArrayAdapter<Teritorry> dataAdapter = new ArrayAdapter<>(DcrApprovalListActivity.this, android.R.layout.simple_spinner_item, teritoryList);
                dataAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
    ...
    @Override
    public void approveKlick(DcrApprovalData elt) {
        if (RoleTypeId == 2) {
