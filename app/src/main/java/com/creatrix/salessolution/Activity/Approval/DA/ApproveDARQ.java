...
public class ApproveDARQ {
    ...
    public int getTADAApprovalId() {
        return TADAApprovalId;
    }

    public void setTADAApprovalId(int TADAApprovalId) {
        this.TADAApprovalId = TADAApprovalId;
    }
