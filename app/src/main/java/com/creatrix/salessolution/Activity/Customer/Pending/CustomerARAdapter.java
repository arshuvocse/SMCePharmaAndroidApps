...
public class CustomerARAdapter extends RecyclerView.Adapter<CustomerARAdapter.vh> {
    private Context context;
    List<CustomerARModel> cList;

    String from="";
    public CustomerARAdapter(List<CustomerARModel> cList, Context context) {
        this.cList = cList;
    ...
    public static class vh extends RecyclerView.ViewHolder {
        public TextView customerstatus, custName, custmarket,custmarketcode, custmobile, custstatus, custowner, custaddress, custptype, custpwaiting;
        ...
        public vh(View view) {
            ...
            custmarketcode = (TextView) view.findViewById(R.id.custmarketcode);
    ...
    public void onBindViewHolder(@NonNull vh holder, int position) {
        if (cList != null) {
            ...
            if (ps.getCustomerStatus().equals("Inactive")) {
                holder.ll_master.setBackgroundColor(Color.parseColor("#C12222"));
                holder.customerstatus.setTextColor(Color.parseColor("#ffffff"));
            }
            holder.customerstatus.setText(ps.getCustomerStatus());
            holder.custName.setText(ps.getCustomerName());
            holder.custmarket.setText(ps.getMarketName());
            holder.custmarketcode.setText(ps.getMarketCode());
