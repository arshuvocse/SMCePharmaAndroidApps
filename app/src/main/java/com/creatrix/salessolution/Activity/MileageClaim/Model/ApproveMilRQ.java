package com.creatrix.salessolution.Activity.MileageClaim.Model;

public class ApproveMilRQ {
    int MileageApprovalId;
    String Date;
    int FromEmpId;
    int ToEmpId;
    int TableId;
    ...
    public int getMileageApprovalId() {
        return MileageApprovalId;
    }

    public void setMileageApprovalId(int mileageApprovalId) {
        MileageApprovalId = mileageApprovalId;
    }
